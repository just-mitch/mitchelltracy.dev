    ...
    <>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <h3 className="mt-4 text-sm font-medium italic tracking-tight text-zinc-800 dark:text-zinc-100">
            But first, do no harm.
          </h3>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Mitch, a software engineer based in Maryland. I am searching for
            a full-time position at a company that is developing advanced
            technology in pursuit of a brighter future. Think I’d be a good fit
            with your team?{' '}
            <a
              className="font-medium text-zinc-900 dark:text-zinc-100"
              href="https://calendly.com/mitchell-tracy/quick-intro"
              target="_blank"
